...
variable "node_ram_dedicated" {
  description = "Dedicated RAM for the node"
  type        = number
}

variable "node_iso" {
  description = "ISO image for the node"
  type        = string
}

variable "node_update_iso" {
  description = "Update ISO image for the node"
  type        = string
  default     = null
}
...
variable "node_update" {
  description = "Whether to update the node"
  type        = bool
  default     = false
}
